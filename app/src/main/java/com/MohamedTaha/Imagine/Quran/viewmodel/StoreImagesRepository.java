...
public class StoreImagesRepository {
    ...
    private MutableLiveData<List<Integer>> mutableLiveDataImageString = new MutableLiveData<>();
    ...
    public MutableLiveData<List<Integer>> getMutableLiveDataImage() {
        ...
        // return mutableLiveDataImageString;
    }

    private void setName_Sroa() {
        a = application.getResources().getStringArray(R.array.name_allSwar_read);
        nzol_elsora = application.getResources().getStringArray(R.array.nzolElswar);
